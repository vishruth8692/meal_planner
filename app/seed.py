...
STARTER_DISHES = [
    ...
    ("Paneer butter masala", DietType.veg, "paneer", MealType.lunch, "paneer, tomato, cream, butter", 14, 320, True, N),
    ("Palak paneer", DietType.veg, "paneer", MealType.lunch, "spinach, paneer", 13, 280, False, N),
    ...
    ("Egg curry", DietType.egg, "egg", MealType.lunch, "egg, onion, tomato", 12, 220, False, U),
    ("Chicken curry", DietType.non_veg, "chicken", MealType.lunch, "chicken, onion, tomato", 25, 320, False, U),
    ("Chicken fry", DietType.non_veg, "chicken", MealType.dinner, "chicken, spices", 27, 300, False, U),
    ("Fish curry", DietType.non_veg, "fish", MealType.lunch, "fish, coconut, tamarind", 22, 260, False, S),
    ("Mutton curry", DietType.non_veg, "mutton", MealType.lunch, "mutton, onion, spices", 24, 350, False, U),
    ...
    ("Veg noodles", DietType.veg, "vegetable", MealType.dinner, "noodles, cabbage, carrot, capsicum, soy sauce", 6, 320, False, U),
    ("Veg pasta", DietType.veg, "vegetable", MealType.dinner, "pasta, tomato, cheese, mixed vegetables", 9, 340, False, U),
